...
class DriverServiceTest {
        ...
        class SubmitDocumentsTests {
                ...
                void submitDocuments_Success() {
                        ...
                        when(driverDocumentsRepository.save(any(DriverDocuments.class)))
                                        .thenReturn(testDriverDocuments);

                        // Act
                        DriverDocumentsResponse response = driverService.submitDocuments(testDocumentsRequest);
                ...
                @Test
                @DisplayName("Should throw DuplicateResourceException when documents already submitted")
                void submitDocuments_AlreadySubmitted() {
                        // Arrange
                        when(driverRepository.findById(1)).thenReturn(Optional.of(testDriver));
                        when(driverDocumentsRepository.findByDriverDriverId(1))
                                        .thenReturn(Optional.of(testDriverDocuments));
                ...
                @Test
                @DisplayName("Should throw DuplicateResourceException for duplicate license number")
                ...
                @Test
                @DisplayName("Should throw DuplicateResourceException for duplicate Aadhaarnumber")
                ...
                @Test
                @DisplayName("Should throw DuplicateResourceException for duplicate PAN cardnumber")
        ...
        class GetDocumentStatusTests {
                ...
                @Test
                @DisplayName("Should throw ResourceNotFoundException when no documentsfound")
        ...
        class SubmitVehicleDetailsTests {
                ...
                void submitVehicleDetails_Success() {
                        ...
                        // Act
                        VehicleDetailsResponse response = driverService.submitVehicleDetails(testVehicleRequest);
                ...
                void submitVehicleDetails_DriverNotFound() {
                        ...
                        // Act & Assert
                        assertThatThrownBy(() -> driverService.submitVehicleDetails(testVehicleRequest))
                                        .isInstanceOf(DriverNotFoundException.class)
                                        .hasMessageContaining("Driver not found with ID: 1");
                }

                @Test
                @DisplayName("Should throw DuplicateResourceException when vehicle alreadysubmitted")
                void submitVehicleDetails_AlreadySubmitted() {
                        // Arrange
                        when(driverRepository.findById(1)).thenReturn(Optional.of(testDriver));
                        when(vehicleDetailsRepository.findByDriverDriverId(1))
                                        .thenReturn(Optional.of(testVehicleDetails));
                ...
                @Test
                @DisplayName("Should throw DuplicateResourceException for duplicateregistration number")
                ...
                @Test
                @DisplayName("Should throw DuplicateResourceException for duplicate insurancenumber")
                ...
                @Test
                @DisplayName("Should throw DuplicateResourceException for duplicate RCnumber")
                ...
                void submitVehicleDetails_DifferentVehicleTypes() {
                        ...
                        // Act
                        VehicleDetailsResponse response = driverService.submitVehicleDetails(bikeRequest);
        ...
        class GetVehicleDetailsTests {
                ...
                @Test
                @DisplayName("Should throw ResourceNotFoundException when no vehicle detailsfound")
